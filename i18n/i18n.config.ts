export default defineI18nConfig(() => ({
	...
	messages: {
		zh: {
			...
			nav_menu: "菜单",
			footer_nav: "页脚导航",
			rom_table_caption: "刷机包下载列表",
			suspended_table_caption: "已撤包 ROM 列表",
			error_title: "页面出错了",
		...
		en: {
			...
			rom_table_caption: "ROM download list",
			suspended_table_caption: "Suspended ROM list",
