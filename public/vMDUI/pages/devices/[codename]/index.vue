                ...
                <table>
                  ...
                  <tbody>
                    <tr v-for="{ os, android, recovery, fastboot } in roms">
                      ...
                      <td v-else><a :href="('https://cdn-ota.azureedge.net/' + os + '/' + recovery)"><span v-if="$device.isDesktopOrTablet">{{ recovery }}</span><span v-else>{{ $t('recovery') }}</span></a></td>
                      <td v-if="fastboot == ''">{{ $t('yet') }}</td>
                      <td v-else><a :href="('https://cdn-ota.azureedge.net/' + os + '/' + fastboot)"><span v-if="$device.isDesktopOrTablet">{{ fastboot }}</span><span v-else>{{ $t('fastboot') }}</span></a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
