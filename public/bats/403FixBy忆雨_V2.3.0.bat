...
exit
:undo
findstr /i /c:"183.136.207.132" %hosts% >nul || findstr /i /c:"47.74.196.250" %hosts% >nul || findstr /i /c:"110.43.121.13" %hosts% >nul || findstr /i /c:"110.43.121.249" %hosts% >nul || findstr /i /c:"123.6.13.6" %hosts% >nul || goto nocontent
