export default defineI18nConfig(() => ({
  ...
  messages: {
    zh: {
      ...
      'checkit':'前往查看',
      'dev_title': '网站正在完善中',
      'developing': '网站正在完善中，我们正在努力为您提供更好的服务，预计10分钟后恢复,敬请期待。',
    ...
    en: {
      ...
      'developing': 'We are improving our website for better experience, please wait for a while,we will come back in 10 minutes time.',
