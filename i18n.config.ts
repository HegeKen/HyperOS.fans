...
function defineI18nConfig(arg0: () => { legacy: boolean; locale: string; messages: { zh: { home: string; devices: string; code: string; supported: string; sitev: string; name: string; log: string; time: string; sitelog: string; codename: string; miui: string; recovery: string; fastboot: string; android: string; devinfo: string; os: string; sources: string; 'source-code': string; yes: string; data: string; no: string; coolapk: string; fixed: string; source: string; top: string; lang: string; hometitle: string; devlist: string; rompage: string; yet: string; disclaimerlong: string; disclaimer: string; gotomiui: string; miuier: string; dev: string; supports: string; latedev: string; update: string; devtitle: string; num: string; week: string; download: string; uptime: string; versions: string; comm: string; gcom: string; comlink: string; description: string; attention: string; logs: string; roms: string; totop: string; release: string; tips: string; fix403: string; method1: string; '1step1': string; '1step2-1': string; '1step2': string; '1step3': string; method2: string; '2step1-1': string; '2step1-2': string; '2step2-1': string; '2step2-2': string; bllock: string; unlock: string; unlockurl: string; suspended: string; note: string; suspendednote: string; }; en: { home: string; devices: string; code: string; supported: string; sitev: string; sitelog: string; name: string; log: string; time: string; codename: string; miui: string; devinfo: string; recovery: string; fastboot: string; android: string; os: string; yes: string; data: string; fixed: string; comm: string; gcom: string; coolapk: string; download: string; source: string; top: string; lang: string; no: string; hometitle: string; devlist: string; rompage: string; yet: string; disclaimerlong: string; disclaimer: string; gotomiui: string; miuier: string; dev: string; supports: string; latedev: string; update: string; devtitle: string; num: string; week: string; uptime: string; versions: string; comlink: string; description: string; attention: string; logs: string; roms: string; totop: string; release: string; tips: string; fix403: string; method1: string; '1step1': string; '1step2-1': string; '1step2': string; '1step3': string; method2: string; '2step1-1': string; '2step1-2': string; '2step2-1': string; '2step2-2': string; bllock: string; unlock: string; unlockurl: string; suspended: string; note: string; suspendednote: string; }; }; }) {
